...
def full_scripts() -> dict:
    return {
        ...
        "argue": [
            ...
            position(Stance.BUY, "market leadership is durable vs peers", Direction.BULL),
            position(Stance.PASS, "macro regime is hostile compared to prior cycles", Direction.BEAR),
            position(Stance.BUY, "converged view a vs historical range", Direction.BULL, responses_for_all()),
            position(Stance.BUY, "converged view b vs historical range", Direction.BULL, responses_for_all()),
        ],
